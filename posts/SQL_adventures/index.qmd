...
**SQL Police Department** (voir [@sqlpdLearnWhile]), un serious game développé par Doron Linder (créateur de *Vim Adventures*), réinvente l'apprentissage du SQL en le transformant en un jeu captivant à l'ambiance digne d'une série policière.
