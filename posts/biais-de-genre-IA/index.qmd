...
où : \* $\chi^2$ est la statistique du test chi-carré, \* n est la taille de l'échantillon, \* k est le nombre de colonnes (modalités de la première variable), \* r est le nombre de lignes (modalités de la seconde variable), \* $min(k−1,r−1)$ est le minimum entre le nombre de colonnes moins un et le nombre de lignes moins un.
:::
...
En général, les seuils d'interprétation ne sont pas stricts, mais on utilise souvent les conventions suivantes : \* V \< 0,2 : association faible, \* 0,2 ≤ V \< 0,4 : association modérée, \* 0,4 ≤ V \< 0,6 : association forte, \* V ≥ 0,6 : association très forte.
